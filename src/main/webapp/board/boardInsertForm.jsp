...
<body>
    ...
    <div class="container">
        <form action="/HFProject/boardInsert.do" id="contentPrimary" method="post">
            <div class="m-2">
            	<div class="form-floating">
            		<input type="text" class="form-control" name="postTitle" id="float1" placeholder="Title">
                ...
                <div class="d-flex">
	                <div class="dropdown p-2">
	                    ...
	                    <input type="hidden" name="postType" id="buttonType">
	                </div>
                ...
                <textarea name="postContent" id="tiny"></textarea>
                <br>
                <label for="image" class="form-label">사진 업로드</label>
				<input type="text" id="image" class="form-control" name="imageLink" aria-describedby="image">
